...
(function() {
  ...
  function renderHomepage() {
    ...
    var html = '<section class="zynix-homepage-hero"><div class="zynix-container zynix-inner-hero-grid">' +
      ...
      '<div style="background:var(--z-bg-card,#1a2236);border-radius:20px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 20px 60px rgba(0,0,0,0.3),0 1px 3px rgba(0,0,0,0.15);overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif">' +
      ...
      '</div>' +
      '<div style="display:flex;align-items:center;gap:8px;padding:20px 24px 0"><svg viewBox="0 0 32 32" width="24" height="24" fill="none"><path d="M16 2L4 8v8c0 8.4 5.1 16.2 12 19 6.9-2.8 12-10.6 12-19V8L16 2z" fill="#20449B" opacity="0.25"/><path d="M12 16l3 3 7-7" stroke="#F16529" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg><span style="font-size:15px;font-weight:600;color:var(--z-text,#e2e8f0)">zynix<span style="color:#F16529">.ai</span></span></div>' +
      '<div style="display:flex;gap:0;padding:16px 24px 0;border-bottom:1px solid rgba(255,255,255,0.06)">' +
        '<div style="padding:10px 18px 12px;font-size:13px;font-weight:500;color:rgba(255,255,255,0.55);display:flex;align-items:center;gap:6px"><span style="width:6px;height:6px;border-radius:50%;background:#22c55e;display:block"></span> Care Gap Agent</div>' +
        '<div style="padding:10px 18px 12px;font-size:13px;font-weight:500;color:rgba(255,255,255,0.55);display:flex;align-items:center;gap:6px"><span style="width:6px;height:6px;border-radius:50%;background:#3b82f6;display:block"></span> Outreach Agent</div>' +
        '<div style="padding:10px 18px 12px;font-size:13px;font-weight:500;color:rgba(255,255,255,0.55);display:flex;align-items:center;gap:6px"><span style="width:6px;height:6px;border-radius:50%;background:#C44B16;display:block"></span> AWV Scheduler</div>' +
        '<div style="padding:10px 18px 12px;font-size:13px;font-weight:500;color:var(--z-text,#e2e8f0);border-bottom:2px solid #F16529;display:flex;align-items:center;gap:6px"><span style="width:6px;height:6px;border-radius:50%;background:#22c55e;display:block"></span> Care Team</div>' +
      '</div>' +
      '<div style="display:flex;justify-content:space-between;align-items:center;padding:20px 24px 0">' +
        '<div><div style="font-size:18px;font-weight:600;color:var(--z-text,#e2e8f0);display:flex;align-items:center;gap:10px"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F16529" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg> Care Team + AI Agents</div><div style="font-size:12px;color:rgba(255,255,255,0.5);margin-top:2px">Humans and agents working together to close gaps</div></div>' +
      ...
      '<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;padding:20px 24px">' +
        '<div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:16px;text-align:center"><div style="font-size:28px;font-weight:700;color:#60a5fa;letter-spacing:-1px">5,120</div><div style="font-size:10px;font-weight:600;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1px;margin-top:4px">Patients Managed</div></div>' +
        '<div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:16px;text-align:center"><div style="font-size:28px;font-weight:700;color:#4ade80;letter-spacing:-1px">40%</div><div style="font-size:10px;font-weight:600;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1px;margin-top:4px">Gap Closure Rate</div></div>' +
        '<div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:16px;text-align:center"><div style="font-size:28px;font-weight:700;color:#F16529;letter-spacing:-1px">2.5x</div><div style="font-size:10px;font-weight:600;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:1px;margin-top:4px">ROI Year One</div></div>' +
      '</div>' +
      ...
      '</div>' +
      '<div style="display:flex;align-items:center;gap:8px;padding:12px 24px 16px;background:rgba(74,222,128,0.06);border-top:1px solid rgba(255,255,255,0.04)">' +
